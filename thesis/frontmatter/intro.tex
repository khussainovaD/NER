...
\noindent
The remainder of the thesis is organised as follows. Chapter~\ref{chap:theory} reviews the relevant literature and formulates the research problem. Chapter~\ref{chap:setup} describes the dataset, annotation methodology, and experimental setup. Chapter~\ref{chap:results} presents the comparative analysis and integration of the best model. Chapter~\ref{chap:conclusion} summarises the conclusions and directions for future work.